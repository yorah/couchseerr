...
Pure: the path is a parameter, and nothing here imports Kodi. Slots are keyed by media
type rather than by a user-chosen name because a household thinks "the profile I want
for films", not "a bundle called VF".
