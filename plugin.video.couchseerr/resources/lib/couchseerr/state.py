...
# and a detail listing that offers a request must never disagree.
...
#: to search for. Both tuples live here, next to the one derivation, so the tile, the
#: detail listing and the season listing cannot answer "is this requestable" differently.
